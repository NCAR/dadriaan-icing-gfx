...
#prod = sys.argv[3]
#nhrs = int(sys.argv[4])
indir = '/home/dadriaan/git/dadriaan-icing-gfx/v2'
#gfile = '/scratch/WEEKLY/dadriaan/20201229_i12_f003_HRRR-NCEP_wrfnat.grb2'
gfile = '/var/autofs/mnt/ahmose_d1/dadriaan/projects/sae2019/data/raw/hrrrv4/grib/20190201_i12_f003_HRRRv4_GSD_wrfnat.grb2'
...
for vt in t:
  ...
  os.chdir('/home/dadriaan/git/dadriaan-icing-gfx')
  cmd = 'python native_grib_sounding.py --tstring=\'%s\' --fnum=%d --gribfile=%s' % (ts,fnum,gfile)
  print(cmd)
  os.system(cmd)
